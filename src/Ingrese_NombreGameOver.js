...
if(teclado[teclaFlechaDerecha] && Tecla_Presionada==0 && Escena==2 && IngresNombre==true && Caracter!=3){
			Sonido(true,"SonidoMenu");
		Tecla_Presionada=1;
		Caracter+=1;	Letra=64;
				} 
	
if(teclado[teclaFlechaIzquierda] && Tecla_Presionada==0  && Escena==2 && IngresNombre==true && Caracter!=1){ 
		Sonido(true,"SonidoMenu");
		Tecla_Presionada=1;
		Caracter-=1;	Letra=64; 
...
if(teclado[teclaFlechaDerecha]==false && teclado[teclaFlechaIzquierda]==false &&
 Tecla_Presionada==1){
	Tecla_Presionada=0;
}
...
//C1
if(Caracter==1 && Tecla_PresionadaLetras==0 && 
teclado[teclaFlechaArriba]  && IngresNombre==true 
  && Letra!=91){
	  Sonido(true,"SonidoMenu");
	...
	if(Caracter==1 &&  Tecla_PresionadaLetras==0 &&
teclado[teclaFlechaAbajo]  && IngresNombre==true 
 && Letra!=64  ){
	 Sonido(true,"SonidoMenu");
	 Tecla_PresionadaLetras=1;
	Letra-=1;
