var TiempoPosicionesAnimacion=0;

function Fondo_PosicionesBarras(){
	
	if(Escena==5 && TiempoPosicionesAnimacion<3){ 	TiempoPosicionesAnimacion++; 	} 
				else if(TiempoPosicionesAnimacion>3){ 	TiempoPosicionesAnimacion=4; }

	
if(TiempoPosicionesAnimacion<3 ){
