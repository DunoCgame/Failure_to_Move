var TiempoPortadaAnimacion=0;

function Fondo_PortadaBarras(){
	
	if(Escena==1 && TiempoPortadaAnimacion<3){ 	TiempoPortadaAnimacion++; } 
else if(TiempoPortadaAnimacion>3){ 	TiempoPortadaAnimacion=4; }

	
	if(TiempoPortadaAnimacion<3 ){
